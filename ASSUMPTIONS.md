...
| A5 | Per-rank timing jitter, coefficient of variation | 0.02 | 0.0 to 0.05 | Chosen to produce roughly a 10 percent synchronization tax at 16,384 accelerators, matching the reported magnitude that 42.5 percent of production jobs run at least 10 percent slower from stragglers (S6). Swept in E7. |
